...
#         starting_sp500_value = False
        ...
        if len(each_file) > 0:
            for per_file in each_file:
                date_stamp = datetime.strptime(per_file, '%Y%m%d%H%M%S.html')
                unix_time = time.mktime(date_stamp.timetuple())
                
                full_file_path = each_dir + '/' + per_file
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print("S&P 500 1 year exception: ", str(e))
                    ...
                    try:
                        ...
                        try:
                            ...
                            print("Stock price 1 year exception: ", str(e))
